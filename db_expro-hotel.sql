...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 03, 2024 at 05:15 PM
...
(10014, 'root2', 'my name is groot', 'iamgroot', 'DyCsIlAe');
...
(8, 'Deluxe Room', 1800000, 'Kamar deluxe kami akan membuat Anda merasa seperti raja dengan ruang tamu yang luas dan kamar tidur berukuran King Size. Dengan fasilitas tercanggih dan dekorasi yang mengkilap, kami menyediakan pengalaman terbaik.', 'hotel-3.jpg', 'hG5KL', 3),
...
(16, 8, 'Johnny Bravo', '2024-06-22', '2024-06-23', '0914623462578', '56325557890', 1, '1800000', 'Jangan buat wajah tampan ini terlihat seperti pecundang.'),
...
--
ALTER TABLE `reservasi_kamar`
  MODIFY `reservasi_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
